...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <body>
    ...
    <div class="container">
    	<legend>Mantenedor de permisos</legend>
    	
    	<p style="text-align:right;">
    		<a class='btn btn-success' href='#dlgAgregar' data-toggle='modal'>
    			<i class='icon-file icon-white'></i>Agregar permiso
    		</a>
    	</p>
    	<!--TABLA DE BUSCADORES-->
		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="example">
			...
			<tfoot>
				<tr>
					...
					<th data-column="1">URL</th>
					<th data-column="2">M&oacute;dulo</th>
					<th data-column="3">Estado</th>
					<th data-column="4">Acciones</th>
				</tr>
				<tr>
		    ...
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>  
		          ...
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="Nuevo_url" placeholder="Nuevo Módulo">	            
		            </div>  
		          </div>
		          <div class="control-group">  
