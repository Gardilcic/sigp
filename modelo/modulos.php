<?php
	...
	if($_POST['funcion']=="listar_modulos")
	{
		...
		$cns = "select id, nombre, estado from vista_usuarios_modulos order by nombre ASC";
	...
	{
		$cns = "EXEC [dbo].[crea_modulo_usuarios] @nombre = N'".decoder($_POST['nombre'])."', @estado = ".$_POST['estado'];
	...
	if($_POST['funcion']=="updt_modulo")
	{
		...
		$cns = "EXEC [dbo].[actualiza_modulo_usuarios] @nombre = N'".decoder($_POST['nombre'])."', @estado = ".$_POST['estado'].", @id = ".$_POST['id'];
